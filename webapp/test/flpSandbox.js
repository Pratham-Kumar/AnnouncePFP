		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Announce PFP",
									"targetURL": "#comsapannouncepfp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapannouncepfp-display": {
								"semanticObject": "comsapannouncepfp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.announcepfp",
									"url": sap.ui.require.toUrl("com/sap/announcepfp")
								}
							}
						}
					}
